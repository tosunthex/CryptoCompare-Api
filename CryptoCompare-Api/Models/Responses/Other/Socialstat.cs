...
namespace CryptoCompare_Api.Models.Responses.Other
{
    public class Socialstat
    {
        ...
        [JsonProperty("Data")] 
        public SocialstatData Data { get; set; }
    }
    ...
    public class List
    {
        ...
        public long OpenPullIssues { get; set; }
        ...
        public long ClosedTotalIssues { get; set; }
        ...
        public long ClosedPullIssues { get; set; }

        [JsonProperty("open_total_issues")]
        public long OpenTotalIssues { get; set; }
    ...
    public class Reddit
    {
        ...
        public long CommunityCreation { get; set; }
