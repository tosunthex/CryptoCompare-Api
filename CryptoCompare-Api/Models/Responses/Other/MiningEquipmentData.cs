...
{
    public partial class MiningEquipmentData
    {
        [JsonProperty("Id")]
        ...
        [JsonProperty("HashesPerSecond")]
        public string HashesPerSecond { get; set; }
        ...
        [JsonProperty("CurrenciesAvailable")]
        public string CurrenciesAvailable { get; set; }
