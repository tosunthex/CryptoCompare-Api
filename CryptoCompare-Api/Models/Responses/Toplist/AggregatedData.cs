...
namespace CryptoCompare_Api.Models.Responses.Toplist
{
    public class AggregatedData
    {
        ...
        [JsonProperty("LASTVOLUME")] public double Lastvolume { get; set; }

        [JsonProperty("LASTVOLUMETO")] public double Lastvolumeto { get; set; }
        ...
        [JsonProperty("VOLUME24HOUR")] public double Volume24Hour { get; set; }

        [JsonProperty("VOLUME24HOURTO")] public double Volume24Hourto { get; set; }
        ...
        [JsonProperty("OPEN24HOUR")] public double Open24Hour { get; set; }

        [JsonProperty("HIGH24HOUR")] public double High24Hour { get; set; }

        [JsonProperty("LOW24HOUR")] public double Low24Hour { get; set; }

        [JsonProperty("LASTMARKET", NullValueHandling = NullValueHandling.Ignore)]
        public string Lastmarket { get; set; }

        [JsonProperty("CHANGE24HOUR")] public double Change24Hour { get; set; }

        [JsonProperty("CHANGEPCT24HOUR")] public double Changepct24Hour { get; set; }

        [JsonProperty("CHANGEDAY")] public double Changeday { get; set; }

        [JsonProperty("CHANGEPCTDAY")] public double Changepctday { get; set; }
