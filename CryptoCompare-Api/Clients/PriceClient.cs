...
namespace CryptoCompare_Api.Clients
{
    public class PriceClient:BaseApiClient,IPriceClient
    {
        ...
        {
            return await GetAsync<MultipleSymbolFullData>(PriceApiUrls.MultipleSymbolFullData(fsyms, tsyms,tryConversion, e))
                .ConfigureAwait(false);
        }

        public async Task<MultipleSymbolPrice> GetMultipleSymbolPrice(string[] fsyms, string[] tsyms, bool? tryConversion = null, string e = null)
        {
            return await GetAsync<MultipleSymbolPrice>(PriceApiUrls.MultipleSymbolPrice(fsyms, tsyms, tryConversion, e))
                .ConfigureAwait(false);
        }

        public async Task<SingleSymbolPrice> GetSingleSymbolPrice(string fsym, string[] tsyms, bool? tryConversion = null, string e = null)
        {
