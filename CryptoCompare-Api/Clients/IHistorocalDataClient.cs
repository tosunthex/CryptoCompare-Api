...
namespace CryptoCompare_Api.Clients
{
    public interface IHistorocalDataClient
    {
        ...
        /// <returns></returns>
        Task<HistoricalOhlcv> GetHistoricalDailyOHLCV(string fsym, string tsym, string e = null,
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalOhlcv> GetHistoricalHourlyOHLCV(string fsym, string tsym, string e = null,
            int? aggregate = null, int? limit = null, string toTs = null);
        /// <summary>
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalOhlcv> GetHistoricalMinuteOHLCV(string fsym, string tsym, string e = null,
            int? aggregate = null, int? limit = null, string toTs = null);
        /// <summary>
        ...
        /// <param name="calculationType">Type of average to calculate (Close - a Close of the day close price,
        /// MidHighLow - the average between the 24 H high and low, VolFVolT - the total volume to / the total volume
        /// from) [Max character length: 30]</param>
        /// <returns></returns>
        Task<HistoricalDayOhlcvForATimestamp> GetHistoricalDayOhlcvForaTS(string fsym, string[] tsyms, string ts=null, string e=null,
        ...
        /// <param name="tsym">REQUIRED The currency symbol to convert into [Max character length: 10]</param>
        /// <param name="e">The exchange to obtain data from (our aggregated average - CCCAGG - by default) [Max character length: 30]</param>
        /// <param name="avgType">Type of average to calculate (HourVWAP - a HourVWAP of hourly price, MidHighLow - the average between the 24 H high and low, VolFVolT - the total volume to / the total volume from) [Max character length: 30]</param>
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalDayAveragePrice> GetHistoricalDayAveragePrice(string fsym, string tsym, string e=null, string avgType=null,
            string utcHourDiff=null, string toTs=null);
        /// <summary>
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalExchangeVolume> GetHistoricalDailyExchangeVolume(string tsym, string e = null,
            int? aggregate = null, int? limit = null, string toTs = null);
        /// <summary>
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalExchangeVolume> GetHistoricalHourlyExchangeVolume(string tsym, string e = null,
            int? aggregate = null, int? limit = null, string toTs = null);
