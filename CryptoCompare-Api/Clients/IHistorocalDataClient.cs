...
namespace CryptoCompare_Api.Clients
{
    public interface IHistorocalDataClient
    {
        ...
        /// </param>
        /// <returns></returns>
        Task<HistoricalDayOhlcvForATimestamp> GetHistoricalDayOhlcvForaTS(string fsym, string[] tsyms, string ts = null,
            string e = null,
        ...
        /// <param name="toTs">Last unix timestamp to return data for</param>
        /// <returns></returns>
        Task<HistoricalDayAveragePrice> GetHistoricalDayAveragePrice(string fsym, string tsym, string e = null,
            string avgType = null,
